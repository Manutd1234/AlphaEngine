    ...
    <div className="card">
      ...
      <div ref={ref}>
        ...
        >
          ...
          <text x={x0} y={height - 8} fontSize={12} fontFamily="var(--mono)" fill="var(--text-muted)">
            {stamp(points[0].t)}
          </text>
          <text x={x1} y={height - 8} textAnchor="end" fontSize={12} fontFamily="var(--mono)" fill="var(--text-muted)">
            {stamp(last.t)}
          </text>
        </svg>
      </div>
