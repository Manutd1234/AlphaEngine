...
import { isGatewayOpsSnapshot } from "@/lib/reliability-wire";

// The wire gate lives in its own module; re-exported so every caller of this
// one keeps its import.
export { isGatewayOpsSnapshot };
