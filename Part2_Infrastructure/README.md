...
| **Quant Developer** | *Can I change this safely?* | Typed contracts, OpenAPI snapshot, parity suites (Python ↔ TypeScript to 1e-4, Python ↔ C++ to the bit), CI, and three suites re-measured 2026-08-23: gateway **2,141 passed / 2 skipped** (CI's shape; 2,149 / 1 with the re-ranker weights seeded), web **4,436 passed / 2 skipped**, service **14 passed** (§8 reconciles the gateway figure with the smaller one CI prints without the re-ranker weights) | No generated client, no property-based fuzzing |
...
npm test       # 4,438 tests across 974 suites: 4,436 passed, 2 skipped (2026-08-23)
```
...
cd web && npm install && npm test         # 4,438 workspace tests across 974 suites — 4,436 passed,
...
The web suite itself is green (4,436 passed, 2 skipped) and the count gate lives
