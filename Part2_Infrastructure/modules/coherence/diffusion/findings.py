...
def collect(*, runs_store: AbsorptionRunStore | None = None,
    ...
    return {
        ...
        "study": {
            ...
            "skill_baseline_r2": study.get("skill_baseline_r2"),
            "skill_gain": study.get("skill_gain"),
            "skill_shuffled_p": study.get("skill_shuffled_p"),
            "skill_stage_minutes": study.get("skill_stage_minutes"),
        } if study else None,
        "calendar": {
