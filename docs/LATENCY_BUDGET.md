...
|---|---|---|---|---|---|
| python — decision | 25.4 µs | 57.5 µs | 126.0 µs | 223.6 µs | 5000 |
| native — decision | 15.5 µs | 34.8 µs | 77.2 µs | 160.5 µs | 5000 |
| native — core (inside the engine) | 83 ns | 125 ns | 209 ns | 1.88 µs | 5000 |
<!-- bench:end -->
